...
class GeneratorRnn:
    ...
    def load_model(self,batch_size):
        self.model = RnnGenerateNet(batch_size=batch_size)
        self.model.eval()
    ...
    def generate(self,n,save=True):
        ...
        X_dataset=RnnGenerateDataset(numpy_array=X,inference=True,use_cuda=self.use_cuda)
...
if __name__=='__main__':
    ...
    if server:
        ...
        model_name = 'vae_generation_autoenc.pt'
    ...
    g=GeneratorRnn(model_path=model_path,model_name=model_name,dataset_path=dataset_path,tags_path=tags_path,temp_filepath=temp_filepath)
    g.count_parameters()
