...
N_EPOCHS=300
for beta in [250]:
    for name,batch_size in [('Supervised',256)]:
        BATCH_SIZE=batch_size
        local_dataset='/home/ftamagnan/dataset/FillsExtracted'+name+'07_cc_cc.npz'
        ...
        tg.split_data()
        tg.train_model()
        tg.save_model("./../models/",'sketchrnn_'+name+'_'+str(beta)+'_v4.pt')