...
class GeneratorSketchRnn:
    ...
    def generate(self,n,save=True):
        ...
        rp=X[:, 0:3, :, :].reshape((X.shape[0],16*3,9))
    ...
    def generate_from(self,array,tag,save=True,th=0.5):
        ...
        array_merge_48=encoder.encode_808(array_merge)
        array_48=array_merge_48.reshape((n,4,16,9))
