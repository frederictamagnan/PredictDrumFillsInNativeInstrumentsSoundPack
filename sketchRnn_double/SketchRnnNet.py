...
class SketchEncoder(nn.Module):
    ...
    def __init__(self,batch_size=256,num_features=9,gru_hidden_size=64,seq_len=32,num_directions=2,linear_hidden_size=[64,32]):
...
class SketchDecoder(nn.Module):
    ...
    def __init__(self,batch_size=256,num_features=9,seq_len=32,linear_hidden_size=[64,32]):
