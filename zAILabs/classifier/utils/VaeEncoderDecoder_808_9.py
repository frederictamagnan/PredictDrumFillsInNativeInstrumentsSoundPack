...
from classifier.utils.vae_rnn_custom_nine_v2 import *
from classifier.utils.VaeDataset import VaeEncodeDataset
from classifier.utils.VaeDataset import VaeDecodeDataset
from classifier.utils.utils import tensor_to_numpy

# from vae_rnn_custom_nine_v2 import *
...
class VaeEncoderDecoder:
    ...
    def __init__(self):
        ...
        self.vae.load_state_dict(torch.load(
            "./classifier/utils/models/vae_L1E-02_beta2E+01_beat8_loss9E+00_tanh_gru64_e45_b8192_hd64-32_20190201_202012.pt",
