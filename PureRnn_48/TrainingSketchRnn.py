...
class TrainingSketchRnn:
    ...
    def train_model(self):
        ...
        sketchrnn = SketchDecoder(batch_size=self.batch_size,linear_hidden_size=self.linear_hidden_size).to(self.device)
...
if __name__=="__main__":
    ...
    if not(server):
        ...
        tg.split_data()
        tg.train_model()
        tg.save_model("./../models/",'rnn_48.pt')
